...
export default function Home() {
  ...
  async function loadNFTs() {
    const provider = new ethers.providers.JsonRpcProvider("https://goerli.infura.io/v3/bfd85273741444f4bcf93f880b9b79e0")
    ...
    const items = await Promise.all(data.map(async i => {
      ...
      if(tokenUri.includes("infura")){
        tokenUri = tokenUri.split("ipfs/")[1];
